...
start /wait cmd /k mvn exec:java@Register -Dexec.args="-n Client_1 -a 10 -ns %numberReplicas% -pw abc"
echo Register Client_2
start /wait cmd /k mvn exec:java@Register -Dexec.args="-n Client_2 -a 10 -ns %numberReplicas% -pw abc"
