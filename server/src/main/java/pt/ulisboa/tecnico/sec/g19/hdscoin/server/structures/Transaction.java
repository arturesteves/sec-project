...
public final class Transaction {
	...
	public Transaction (int id, Ledger source, Ledger target, double amount, String nonce, String hash, String previousHash, TransactionType type) throws InvalidLedgerException, InvalidAmountException, InvalidValueException{
		...
		if (hash == null || hash.trim ().equals ("") || previousHash == null || previousHash.trim ().equals ("")) {
	...
	public Transaction (Ledger source, Ledger target, double amount, String nonce, String hash, String previousHash, TransactionType type) throws InvalidLedgerException, InvalidAmountException, InvalidValueException{
